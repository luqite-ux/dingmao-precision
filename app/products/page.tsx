...
export default async function ProductsPage({ searchParams }: { searchParams: Promise<{ category?: string }> }) {
  ...
  return <><PageHero compact eyebrow="PRODUCT CATALOG" title="Precision components, organized for real RFQs." intro="Explore representative parts from our active manufacturing catalog. Dimensions, material, finish, and production requirements are confirmed from your drawing." action={{ label: 'Send a drawing', href: '/contact' }} />
